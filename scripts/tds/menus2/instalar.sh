...
addMenuItem "menuInstall" "Centos 7 apache"  install0
addMenuItem "menuInstall" "Centos 7 php"  install1
addMenuItem "menuInstall" "Centos 7 Cpanel"  install2
addMenuItem "menuInstall" "Go back" loadMenu "mainMenu"


function install0() {
	echo "${BLUE}Install apache...${NORMAL}"
	sudo apt install zip unzip apache2 -y
	echo "${WHITE}Instalado apache!"
	banner 2
}

function install1() {
echo "${BLUE}Install php...${NORMAL}"
